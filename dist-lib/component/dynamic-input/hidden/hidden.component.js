...
var HiddenComponent = /** @class */ (function (_super) {
    ...
    __decorate([
        core_1.Input()
    ], HiddenComponent.prototype, "data");
    __decorate([
        core_1.Input()
    ], HiddenComponent.prototype, "option");
    __decorate([
        core_1.Input()
    ], HiddenComponent.prototype, "fieldCreation");
    __decorate([
        core_1.Input()
    ], HiddenComponent.prototype, "inputIndex");
    __decorate([
        core_1.Input()
    ], HiddenComponent.prototype, "rowIndex");
    __decorate([
        core_1.Output()
    ], HiddenComponent.prototype, "callBack");
    __decorate([
        core_1.Output()
    ], HiddenComponent.prototype, "panelCallBack");
