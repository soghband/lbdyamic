...
var QrCodeComponent = /** @class */ (function (_super) {
    ...
    function QrCodeComponent() {
        ...
        _this.enableScannerString = "Scanner Off";
        _this.hideCamera = true;
        return _this;
    }
    ...
    QrCodeComponent.prototype.addMultiVal = function () {
        this.data[this.fieldCreation.fieldName].push("");
    };
    QrCodeComponent.prototype.deleteMultiVal = function (dataIndex) {
        if (this.data[this.fieldCreation.fieldName].length > 0) {
            this.data[this.fieldCreation.fieldName].splice(dataIndex, 1);
        }
    };
    QrCodeComponent.prototype.processKeyUp = function (event, action, dataIndex) {
        this.callBack.emit({
            event: event,
            action: action,
            dataIndex: dataIndex,
    ...
    QrCodeComponent.prototype.processKeyDown = function (event, action, dataIndex) {
    ...
    QrCodeComponent.prototype.processCallBackKeyPress = function (event, action, dataIndex) {
        this.callBack.emit({
            event: event,
            action: action,
            dataIndex: dataIndex,
    ...
    QrCodeComponent.prototype.processCall = function (data) {
    };
    QrCodeComponent.prototype.processPanelCallBack = function () {
        this.panelCallBack.emit({
            feildName: this.fieldCreation.fieldName
        });
    };
    QrCodeComponent.prototype.displayCameras = function (cameras) {
        console.log(cameras);
        this.availableDevices = cameras;
        this.selectedDevice = this.scanner.getDeviceById(this.availableDevices[0].deviceId);
    };
    QrCodeComponent.prototype.handleQrCodeResult = function (data) {
    ...
    QrCodeComponent.prototype.toggleScanner = function () {
    ...
    __decorate([
        core_1.Input()
    ], QrCodeComponent.prototype, "data");
    __decorate([
        core_1.Input()
    ], QrCodeComponent.prototype, "option");
    __decorate([
        core_1.Input()
    ], QrCodeComponent.prototype, "fieldCreation");
    __decorate([
        core_1.Input()
    ], QrCodeComponent.prototype, "inputIndex");
    __decorate([
        core_1.Input()
    ], QrCodeComponent.prototype, "rowIndex");
    __decorate([
        core_1.Output()
    ], QrCodeComponent.prototype, "callBack");
    __decorate([
        core_1.Output()
    ], QrCodeComponent.prototype, "panelCallBack");
    __decorate([
        core_1.ViewChild("qrScanner")
