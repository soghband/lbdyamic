...
var TextAreaComponent = /** @class */ (function (_super) {
    ...
    __decorate([
        core_1.Input()
    ], TextAreaComponent.prototype, "data");
    __decorate([
        core_1.Input()
    ], TextAreaComponent.prototype, "option");
    __decorate([
        core_1.Input()
    ], TextAreaComponent.prototype, "fieldCreation");
    __decorate([
        core_1.Input()
    ], TextAreaComponent.prototype, "inputIndex");
    __decorate([
        core_1.Input()
    ], TextAreaComponent.prototype, "rowIndex");
    __decorate([
        core_1.Output()
    ], TextAreaComponent.prototype, "callBack");
    __decorate([
        core_1.Output()
    ], TextAreaComponent.prototype, "panelCallBack");
