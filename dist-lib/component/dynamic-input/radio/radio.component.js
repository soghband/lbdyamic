...
var RadioComponent = /** @class */ (function (_super) {
    ...
    __decorate([
        core_1.Input()
    ], RadioComponent.prototype, "data");
    __decorate([
        core_1.Input()
    ], RadioComponent.prototype, "option");
    __decorate([
        core_1.Input()
    ], RadioComponent.prototype, "fieldCreation");
    __decorate([
        core_1.Input()
    ], RadioComponent.prototype, "inputIndex");
    __decorate([
        core_1.Input()
    ], RadioComponent.prototype, "rowIndex");
    __decorate([
        core_1.Output()
    ], RadioComponent.prototype, "callBack");
    __decorate([
        core_1.Output()
    ], RadioComponent.prototype, "panelCallBack");
